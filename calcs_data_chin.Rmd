...
<u>Harvest rate</u>:  Using the Puget Sound <a href = "https://framverse.github.io/fram_doc/calcs_glossary.html#Terminal_Area_Management_Module_(TAMM)" target = "_blank" title = "TAMM: Terminal Area Management Module">TAMM</a>, a terminal area harvest rate can be applied to terminal area fisheries.
...
The starting cohort size in time step 1 is a product of two parameters: (*1*) the base period cohort abundance for stock *s* at age *a* (<span title = "Base period cohort abundance estimate of stock s at age a">$BPCohorts_{s,a}$</span>) and (*2*) a stock and age-specific recruit scaler (<span title = "Stock recruit scaler of stock s at age a">$StockScalers_{s,a}$</span>).  The <a href = "https://framverse.github.io/fram_doc/calcs_glossary.html#Stock_Recruit_Scaler" target = "_blank" title = "Stock recruit scaler">stock recruit scaler</a> is an annual model input.
...
where <span title = "Discrete natural mortality rate at age a and time step t">$M_{a,t}$</span> is the discrete natural mortality rate for age *a* fish during time step *t* (<a href = "https://framverse.github.io/fram_doc/calcs_appendices.html#Appendix_8" target = "_blank" title = "Appendix 8">Appendix 8</a>).
...
- <span title = "">$FisheryScaler_{f,t}$</span> $\times$ <span title = "Release mortaility rate for sublegal fish in fishery f during time step t">$ShakerReleaseMortalityRate_{f,t}$</span> is the release mortality rate for sublegal fish in fishery *f* and time step *t* (<a href = "https://framverse.github.io/fram_doc/calcs_appendices.html#Appendix_7" target = "_blank" title = "Appendix 7">Appendix 7</a>).
...
**(20)**
<span class = "math">$$MSP_f = \frac{\displaystyle\sum\limits_{s,a,t} Catch_{s,a,f,t}}{TotalCatch_f}$$</span>
