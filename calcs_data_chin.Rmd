...
<p>**(13a)** <div style = "text-align:center"> $CNRScaler_{f,t} =$ $\frac{\textbf{TotalEstEnc}_{f,t} \times \underline{MSP}_{f}}{\sum_{s} \sum_{a} LegalTempCatch_{s,a,f,t} + \sum_{s} \sum_{a}SublegTempCatch_{s,a,f,t}}$ </div> </p>
