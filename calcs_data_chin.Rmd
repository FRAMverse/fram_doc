...
- <span title = "(Extreme) terminal run size estimate from a forward FRAM calculation">$FRAMescapement$</span> is the (extreme) terminal run size resulting from a forward <span title = "FRAM: Fishery Regulation Assessment Model">FRAM</span> run.
