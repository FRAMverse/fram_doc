...
*Step 2*: Compute the total fishery and time step catch by summing over stocks and age.
...
<p>**(11a)** <div style = "text-align:center"> $CNRLegal_{s,a,f,t} = Catch_{s,a,f,t} \times$ $\frac{\underline{CNRDays}_{f,t}}{\underline{RetentionDays}_{f,t}}$ $\times$ <b>$LegalSelRate$</b>$_{f,t} \times$ <b>$LegalReleaseMortalityRate$</b>$_{f,t}$ </div> </p>

<p>**(11b)** <div style = "text-align:center"> $CNRSub_{s,a,f,t} = Shakers_{s,a,f,t} \times$ $\frac{\underline{CNRDays}_{f,t}}{\underline{RetentionDays}_{f,t}}$ $\times$ <b>$SublegSelRate$</b>$_{f,t}$ </div> </p>
...
<p>**(13a)** <div style = "text-align:center"> $CNRScaler_{f,t} =$ $\frac{\boldsymbol{TotalEstEnc}_{f,t} \times \underline{MSP}_{f}}{\sum_{s} \sum_{a} LegalTempCatch_{s,a,f,t} + \sum_{s} \sum_{a}SublegTempCatch_{s,a,f,t}}$ </div> </p>
...
<p>(**14**) <div style = "text-align:center"> $CNR_{f,t} =$ $\sum_s \sum_a CNRLegal_{s,a,f,t} + \sum_s \sum_a CNRSub_{s,a,f,t}$</div> </p>
...
- $L_s$ = von Bertalanffy $L_{\infty}$ growth parameter for stock $s$ (Asymptotic mean length)<br>
- $K_s$ = von Bertalanffy Brody growth rate coefficient for stock $s$ (Exponential rate of approach to $L_{\infty}$)<br>
- $T0_s$ = von Bertalanffy $T_0$ growth parameter for stock $s$ (Age when the average length was zero)<br>
...
Base period calculation"><u>$MSP$</u>$_f$ $=$</span> <span  class = "math" title = "Catch of stock s at age a in fishery f during time step t divided by the total catch in fishery f">$\frac{\displaystyle\sum\limits_{s,a,t} Catch_{s,a,f,t}}{TotalCatch_f}$</span> </div>
