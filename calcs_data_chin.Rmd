...
BkFRAM calculation" style = "color: blue;">$StockScaler_{s,a}$</span> </div> </p>
...
<p>**(50)**<div style = "text-align:center"><span title = "Stock scaler for stock s at age a during time step 1">$StockScaler_{s,a,t \! = \! 1}$</span> $=$ <span title = "Backwards FRAM target size for stock s at age a.
