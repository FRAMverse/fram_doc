...
Base period calculation"><u>$BPER$</u>$_{s,a,f,t}\times PV_{s,a,f,t} \times$ <span title = "Stock fishery rate scaler for stock s in fishery f at time step t.
Input by user"><b>$SHRF$</b>$_{s,f,t} \times$ <span title = "Model-stock proportion of fishery f
...
Base period calculation"><u>$SLER$</u>$_{s,a,f,t}\times (1-PV_{s,a,f,t}) \times$ <span title = "Stock fishery rate scaler for stock s in fishery f at time step t.
Input by user"><b>$SHRF$</b>$_{s,f,t}\times$ <span title = "Model-stock proportion of fishery f
Base period calculation"><u>$MSP$</u>$_{f}$ </div> </p>
...
$KTime_{s,a,t} = (Age_s – 1) * 12 + MidTimeStep(t)$ </div> </p>
...
<p>**(27)** <div style = "text-align:center"> $MeanLength_{s,a,t} = L_s \times (1-e^{(-K_s \times(KTime_{s,a,t} – T0_s)})$ </div> </p>
...
The following equations compute the proportion of the population that is larger than the modeler specified minimum size limit ($MinLength_{f,t}$).

<p>**(29)** <div style = "text-align:center"> $z_{s,a,f,t} = \frac{(MinLength_{f,t} - MeanLength_{s,a,t})}{StdDev_{s,a,t}}$ </div> </p>
...
- $KTime_{s,a}$ = Time for estimate of VBGF for stock $s$, age $a$<br>
...
- $z_{s,a,f,t}$ = The length z-score. It specifies the number of standard deviations the $MinLength$ is as away from the $MeanLength$<br>
...
When size limits are modeled in FRAM, each fish smaller than the size limit is treated as a sub-legal fish. Sub-legal encounter rates are used to compute releases and release mortalities. Conversely, each fish larger than the size limit is deemed legal and legal encounter rates are used to estimate catch as well as releases and release mortalities in mark selective fisheries. 

FRAM uses different rates to model encounters of legal and sub-legal fish. These rates are computed during the calibration process and are based on landed catch and encounter information during the base period years (2008-2013). As such, they reflect the size limit conditions as they existed at the time.

Having differing rates for legal and sub-legal encounters results in an uneven distribution of legal and sub-legal fish for a stock and age. Therefore, modeling a size limit change using traditional equations (see descriptions at the beginning of this section) generally results in a change of total fishery encounters. This is a questionable outcome since the size limit is evaluated after a fish is encountered. Therefore, equations were incorporated into FRAM to hold encounters in a fishery constant, regardless of the size limit.

The simplest approach for evaluating a size limit change from the base period is to calculate the legal and sub-legal encounters for both the base period and new minimum size limit and then adjust the differences so that total encounters remain constant. Encounter differences occur in the region between the base period size limit and the new minimum size limit (Figures 1-3).
...
$BaseSizeLimitSublegalMortality_{s,a,f,t} = SLER_{s,a,f,t} \times BaseSublegalPop_{s,a,t} \times ShakerReleaseMortalityRate_{f,t} \times FisheryScaler_{f,t}$ </div> </p>

<p>**(40)**<div style = "text-align:center">$NewSizeLimitSublegalMortality_{s,a,f,t} = SLER_{s,a,f,t} \times NewSublegalPop_{s,a,t} \times ShakerReleaseMortalityRate_{f,t} * FisheryScalar_{f,t}$ </div> </p>

<p>**(41)**<div style = "text-align:center">$BaseSizeLimitSublegalEncounters_{s,a,f,t} =$ $\frac{BaseSizeLimitSublegalMortality_{s,a,f,t}}{ShakerReleaseMortalityRate_{f,t}}$ </div> </p>

<p>**(42)**<div style = "text-align:center">$NewSizeLimitSublegalEncounters_{s,a,f,t} =$ $\frac{NewLengthLimitSublegalMortality_{s,a,f,t}}{ShakerReleaseMortalityRate_{f,t}}$ </div> </p>
...
<p>**(44)**<div style = "text-align:center">$BaseSizeLimitLegalEncounters_{s,a,f,t} = Cohort_{s,a,t} \times BPER_{s,a,f,t} \times FisheryScaler_{f,t} \times BasePV_{s,a,t} \times SHRF_{s,f,t}$ </div> </p>
...
<p>**(46)**<div style = "text-align:center">$NewSizeLimitLegalEncounters_{s,a,f,t} = Cohort_{s,a,t} * BPER_{s,a,f,t} * FisheryScalar_{f,t} * NewPV_{s,a,t} * SHRF_{s,f,t}$ </div> </p>
