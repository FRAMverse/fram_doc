...
<p>**(8a)** <div style = "text-align:center"> $LegalTempCatch_{s,a,f,t} = Cohort_{s,a,t}\times$ <span title = "Base period exploitation rate of stock s at age a in fishery f during time step t.
Base period calculation"><u>$BPER$</u>$_{s,a,f,t}$</span> $\times PV_{s,a,f,t} \times$ <span title = "Stock fishery rate scaler for stock s in fishery f at time step t.
...
<p>**(8b)** <div style = "text-align:center"> $SublegTempCatch_{s,a,f,t} = Cohort_{s,a,t}\times$ <span title = "Sublegal encounter rate of stock s at age a in fishery f during time step t.
Base period calculation"><u>$SLER$</u>$_{s,a,f,t}$</span> $\times (1-PV_{s,a,f,t}) \times$ <span title = "Stock fishery rate scaler for stock s in fishery f at time step t.
Input by user"><b>$SHRF$</b>$_{s,f,t}$</span> $\times$ <span title = "Model-stock proportion of fishery f
Base period calculation"><u>$MSP$</u>$_{f}$ </span> </div> </p>

*Step 2*: Compute the total fishery and time step catch by summing over stocks and ages.

<p>**(9a)** <div style = "text-align:center"> $TotalLegalTempCatch_{f,t} = \sum_{s} \sum_{a}LegalTempCatch_{s,a,f,t}$ </div> </p>

<p>**(9b)** <div style = "text-align:center"> $TotalSublegTempCatch_{f,t} = \sum_{s} \sum_{a}SublegTempCatch_{s,a,f,t}$ </div> </p>

*Step 3*: Compute the legal and sublegal proportion of the catch made up of a given stock and age.

<p>**(10a)** <div style = "text-align:center"> $LegalPropTempCatch_{s,a,f,t} =$ $\frac{LegalTempCatch_{s,a,f,t}}{TotalLegalTempCatch_{f,t}}$ </div> </p>

<p>**(10b)** <div style = "text-align:center"> $SublegPropTempCatch_{s,a,f,t} =$ $\frac{SublegTempCatch_{s,a,f,t}}{TotalSublegTempCatch_{f,t}}$ </div> </p>

where:

- Stock $s$, age $a$, fishery $f$, time step $t$
- $LegalPropTempCatch_{s,a,f,t}$ is the proportion of legal catch of stock $s$, age $a$, in fishery $f$, at time step $t$ using $FisheryScaler$ = 1.0
- $LegalTempCatch_{s,a,f,t}$ is the legal catch using $FisheryScaler$ = 1
- $MSP_{f}$ is the fishery model stock proportion as described in chapter 4.6
- $TotalLegalTempCatch_{f,t}$ is the total catch in fishery $f$ at time step $t$ summed over all stocks $s$ and ages $a$ using $FisheryScaler$ = 1.0
- $TotalSublegTempCatch_{f,t}$ are the total encounters in fishery $f$ at time step $t$ summed over all stocks $s$ and ages $a$ using $FisheryScaler$ = 1.0
- $SublegPropTempCatch_{s,a,f,t}$ is the proportion of sublegal encounters of stock $s$, age $a$, in fishery $f$, at time step $t$ using $FisheryScaler$ = 1.0
- $SublegTempCatch_{s,a,f,t}$ are the sublegal encounters using $FisheryScaler$ = 1.0


<u>CNR Method 1</u> - Computed from relative effort of non-retention to retention period mortality (Fishery Scaler approach)
...
<u>CNR Method 2</u> - Computed from ratio of non-retention to retention days

This method computes non-retention mortalities as a function of the retention input and the ratio of non-retention to retention days. FRAM calculates the legal catch ($Catch_{s,a,f,t}$) and the shaker mortalities ($Shakers_{s,a,f,t}$) as in equations 3 and 5.
...
- Field Value 1: Number of days the non-retention fishery is open within a fishery and time step (<b>$CNRDays$</b>$_{f,t}$)
- Field Value 2: Number of days the retention fishery is open within a fishery and time step (<b>$RetentionDays$</b>$_{f,t}$)
- Field Value 3: Legal selectivity rate (<b>$LegalSelRate$</b>$_{f,t}$)
- Field Value 4: Sublegal selectivity rate (<b>$SublegSelRate$</b>$_{f,t}$)
...
<p>**(11a)** <div style = "text-align:center"> $CNRLegal_{s,a,f,t} = Catch_{s,a,f,t} \times$ $\frac{\boldsymbol{CNRDays}_{f,t}}{\boldsymbol{RetentionDays}_{f,t}}$ $\times$ <b>$LegalSelRate$</b>$_{f,t} \times$ <b>$LegalReleaseMortalityRate$</b>$_{f,t}$ </div> </p>

<p>**(11b)** <div style = "text-align:center"> $CNRSub_{s,a,f,t} = Shakers_{s,a,f,t} \times$ $\frac{\boldsymbol{CNRDays}_{f,t}}{\boldsymbol{RetentionDays}_{f,t}}$ $\times$ <b>$SublegSelRate$</b>$_{f,t}$ </div> </p>

where:

- Stock $s$, age $a$, fishery $f$, time step $t$,
- $CNRLegal_{s,a,f,t}$ is the non-retention mortality of legal Chinook 
- $CNRSub_{s,a,f,t}$ is the non-retention mortality of sublegal Chinook
- $LegalReleaseMortalityRate_{f,t}$ is the mortality rate of legal encounters


<u> CNR Method 3</u> - Computed from external estimate of legal and sub-legal sized encounters

For this method the modeler provides external estimates of legal ($LegalEnc_{f,t}$) and sublegal ($SublegEnc_{f,t}$) fishery encounters. FRAM split encounters into stocks and ages and applies separate a release mortality to legal and sublegal fish.
...
- Field Value 1: External estimate of legal encounters ($LegalEnc_{f,t}$)
- Field Value 2: External estimate of sublegal encounters ($SublegEnc_{f,t}$)

<p>**(12a)** <div style = "text-align:center"> $CNRLegal_{s,a,f,t} =$ <b>$LegalEnc$</b>$_{f,t} \times LegalPropTempCatch_{s,a,f,t} \times$ <b>$LegalReleaseMortalityRate$</b>$_{f,t} \times$ <span title = "Model-stock proportion of fishery f
Base period calculation"><u>$MSP$</u>$_{f}$ </div> </p>

<p>**(12b)** <div style = "text-align:center"> $CNRSub_{s,a,f,t} =$ <b>$SublegEnc$</b>$_{f,t} \times SublegPropTempCatch_{s,a,f,t} \times$ <b>$ShakerReleaseMortalityRate$</b>$_{f,t} \times$ <span title = "Model-stock proportion of fishery f
Base period calculation"><u>$MSP$</u>$_{f}$ </span></div> </p>

<u> CNR Method 4</u> - Computed from external estimates of total encounters
For this method the modeler provides an external estimate of total fishery encounters ($TotalEstEnc_{f,t}$) in Field Value 1 with a flag of "4" in the FRAM non-retention input user interface. FRAM first computes legal and sublegal encounters using a fishery scaler of 1 (equations **10a** and **10b** above). Next, FRAM calculates a $CNRScaler$ to produce total encounters that match the target encounters ($TotalEstEnc$). After multiplying legal and sublegal encounters with the $CNRScaler$, a release mortality is applied to convert encounters into mortalities.

<p>**(13a)** <div style = "text-align:center"> $CNRScaler_{f,t} =$ $\frac{\boldsymbol{TotalEstEnc}_{f,t} \times \underline{MSP}_{f}}{\sum_{s} \sum_{a} (LegalTempCatch_{s,a,f,t} + SublegTempCatch_{s,a,f,t})}$ </div> </p>

<p>**(13b)** <div style = "text-align:center"> $CNRLegal_{s,a,f,t} = LegalTempCatch_{s,a,f,t} \times CNRScaler_{f,t} \times$ <b>$LegalReleaseMortalityRate$</b>$_{f,t}$ </div> </p>

<p>**(13c)** <div style = "text-align:center"> $CNRSub_{s,a,f,t} = SublegTempCatch_{s,a,f,t} \times CNRScaler_{f,t} \times$ <b>$ShakerReleaseMortalityRate$</b>$_{f,t}$ </div> </p>

where:

- Stock $s$, age $a$, fishery $f$, time step $t$,
- $CNRScaler_{f,t}$ scales the FRAM catch to a modeler supplied target catch

<u> Calculation of the Total Chinook Non-Retention Mortality ($CNR_{f,t}$)</u>

$CNR_{f,t}$ is computed by summing non-retention mortalities over stocks and ages for legal and sub-legal Chinook and then summing legal and sublegal fishery, time-step CNR mortalities.

<p>(**14**) <div style = "text-align:center"> $CNR_{f,t} =$ $\sum_s \sum_a (CNRLegal_{s,a,f,t} + CNRSub_{s,a,f,t})$</div> </p>
...
<p>**(47)**<div style = "text-align:center">$LegalEncounterDiff_{s,a,f,t} =$ $BaseSizeLimitLegalEncounters_{s,a,f,t} - NewSizeLimitSublegalEncounters_{s,a,f,t}$ </div> </p>
