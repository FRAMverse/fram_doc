...
First, the total number of sublegal encounters for the fishery-time step are calculated by taking the legal catch from the fishery-time step and multiplying it by an externally provided sublegal:legal ratio (found in the `TargetEncounterRates` table of the `Calibration Support` data base).<br>

Equationxxx
$$Encounters_{f,t}=\sum_{s,a}CWTCatch_{s,a,f,t} * TargetEncounterRate_{f,t}$$
For more information about how to allocate total encounters to stocks and ages, please see <a href="https://framverse.github.io/fram_doc/base_chin_doc_intro.html#Sublegal_Stock-, Age-Composition"> Sublegal Stock-, Age-Composition </a>. For more information about the computation of the proportion legal/sublegal of a stock-age using the Von Bertalannfy growth equation please see  <a href="https://framverse.github.io/fram_doc/calcs_data_chin.html#45_Size_Limit_Evaluations"> Size Limit Caluations</a>.
