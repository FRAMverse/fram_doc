...
[MSP](#MSP) (xxx) is the percentage of a fishery accounted for by stocks in the model. For a detailed description of MSP consult chapter [Model Stock Proportion](#MSP2).
...
See Appendix for <a href="https://framverse.github.io/fram_doc/base_chin_doc_appendix.html#Base_Period_Marked_Catch:" target="_blank">marked MSP</a> and <a href="https://framverse.github.io/fram_doc/base_chin_doc_appendix.html#Base_Period_Total_Catch:" target="_blank">total (marked + unmarked) MSP</a>.

## Target Encounter Rates
Derek

## Terminal Fishery Flags
Terminal fishery flags designate a fishery as terminal (flag 1) or pre-terminal (flag 0). Terminal fisheries operate on "mature" abundances and are therefore processed after maturation occurs. For a definition of terminal fisheries see the <a href="https://framverse.github.io/fram_doc/base_chin_doc_glossary.html#Terminal_Fishery:" target="_blank">Glossary</a>. Terminal fisheries are listed in table `TerminalFisheryFlag` of the calibration database. 
