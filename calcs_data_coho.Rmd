...
<p>**(17)**<div style = "text-align:center"><span title = "Escapement estimate from a forward FRAM calculation for stock s at age 3">$| \ FRAMescapement_{s,a \! = \! 3}$<span> $-$ <span title = "Backwards FRAM escapement or (<a href = "https://framverse.github.io/fram_doc/calcs_glossary.html#Extreme_Terminal_Run_Size_(ETRS)" target = "_blank" title = "Extreme terminal run size">extreme</a>) terminal run size target of stock s at age 3">$BkTarget_{s,a \! = \! 3} \ |$</span> $\le 1$ </div> </p>
