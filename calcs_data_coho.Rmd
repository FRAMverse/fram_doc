...
In reality, in any given time period many stocks are subject to a mixture of NSF and MSF with varying release mortality rates, and mark-recognition is not perfect. Recognition errors for marked fish ($\gamma$, probability that a marked fish is released) reduce the exploitation rate on the marked cohort and introduce bias in the exploitation rate calculation for the marked portion of the stock. Conversely, recognition errors for unmarked fish in MSF ($\xi$, unmarked fish are kept) increase the exploitation rate on an unmarked cohort.
