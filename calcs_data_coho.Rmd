...
Step 1: Calculate unbiased marked ($\widehat{ER}_{Marked,s,f,t}$) and unmarked ($\widehat{ER}_{Marked,s,f,t}$) exploitation rate for stock $s$ in time period $t$ using equations **27** and **28** ($FisheryScaler = 1$). During the first iteration, $ER_{Marked,s,f,t}$ $=$ <u>$BPER$</u>$_{s,f,t}$.
...
$ER_{Marked,s,f} = FisheryScaler_f \times$ <u>$BPER$</u>$_{s,f}$
</div>
