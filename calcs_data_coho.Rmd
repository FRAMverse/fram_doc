...
Non-retention mortalities are calculated external to the model, often derived using historical observations, and are model fishery by time step inputs in units of dead age-3 fish <span title = "Estimated coho non-retention mortalities in fishery f during time step t">$(EstCNRMorts_{f,t})$</span>. Non-retention mortalities by stock are then calculated in <span title = "FRAM: Fishery Regulation Assessment Model">FRAM</span> by multiplying the total non-retention mortality by the stock proportion within each fishery and time step <span title = "Proportion of stock present">$(PropTempCatch_{s,a=3,f,t})$</span>.

<p>**(5)**<div style = "text-align:center"><span title = "Coho non-retention mortalities of stock s in fishery f during time step t">$CNR_{s,f,t}$</span> $=$ <span title = "Estimated coho non-retention mortalities in fishery f during time step t.
Input by user"><b>$EstCNRMorts$</b>$_{f,t}$</span> $\times$ <span title = "Proportion present of stock stock s in fishery f during time step t.
Base period calculation"><u>$PropCatch$</u>$_{s,f,t}$</span> </div> </p>
...
<p>**(7a) Marked:**<div style = "text-align:center"><span title = "Adult release mortalities of stock s at age 3 in fishery f during time step t">$AdultRelMort_{s,a \! = \! 3,f,t}$</span> $=$ <span title = "Cohort abundance of stock s at age 3 during time step t">$Cohort_{s,a \! = \! 3,t}$</span> $\times$ <span title = "Base period exploitation rate for stock s at age 3 in fishery f during time step t.
Base period calculation"><u>$BPER$</u>$_{s,a \! = \! 3,f,t}$</span> $\times$ <span title = "Fishery scaler of fishery f at time step t.
...
<p>**(7b) UnMarked:**<div style = "text-align:center"><span title = "Adult release mortalities of stock s at age 3 in fishery f during time step t">$AdultRelMort_{s,a \! = \! 3,f,t}$</span> $=$ <span title = "Cohort abundance of stock s at age 3 during time step t">$Cohort_{s,a \! = \! 3,t}$</span> $\times$ <span title = "Base period exploitation rate for stock s at age 3 in fishery f during time step t.
Base period calculation"><u>$BPER$</u>$_{s,a \! = \! 3,f,t}$</span> $\times$ <span title = "Fishery scaler of fishery f at time step t.
...
<p> (**13**) <div style = "text-align:center"> $EncounterRate_{Unmarked} = ER \times$ <b>$\delta$</b> </div> </p>
...
<p> (**14**) <div style = "text-align:center"> <span style = "color: red;">$ER$</span>$_{Marked} =$ <b>$FisheryScaler$</b> $\times$ $\overline{ER}$$_{Base} \times 1$ </div> </p>

<p> (**15**) <div style = "text-align:center"> <span style = "color: red;">$ER$</span>$_{Unmarked} =$ <b>$FisheryScaler$</b> $\times$ $\overline{ER}$$_{Base} \times$ <b>$\delta$</b>  </div> </p>
...
<p> (**16**) <div style = "text-align:center"> $\widehat{ER}$$_{Unmarked} =$ $1 - (1 - ER_{Marked})$ <b>$^ \delta$</b>, </div> </p>
...
<p> (**17**) <div style = "text-align:center"> $\widehat{ER}$$_{Unmarked, F} =$ $1 - (1 -$ $\sum_f^F$${ER_{Marked,f}})$ <b>$^ \delta$</b>, </div> </p>
...
<p> (**18**) <div style = "text-align:center"> $\delta_{Marked,f} =$ <b>$mre$</b>$_f + (1 -$ <b>$mre$</b>$_f)$  $\times$ <b>$\delta$</b>$_f$ </div> </p>

Similarly, for the unmarked cohort:

<p> (**19**) <div style = "text-align:center"> $\delta_{Unmarked,f} = (1 -$ <b>$ure$</b>$_f) + ($<b>$ure$</b>$_f$  $\times$ <b>$\delta$</b>$_f)$ </div> </p>
...
<p> (**22**) <div style = "text-align:center"> $\widehat{ER}_{Marked, F} = \sum_{f}^{F} ER_{Marked,f}$ </div> </p>

<p> (**23**) <div style = "text-align:center"> $\widehat{ER}_{Unmarked,F} = 1 - (1 - \sum_{f}^{F} ER_{Marked,f})^{\delta^{W}_{Unmarked}}$ </div> </p>
...
<p> (**24**) <div style = "text-align:center"> $\widehat{ER}_{Marked,F} = 1 - (1 - \sum_{f}^{F} ER_{Marked,f})^{\delta^{W}_{Marked}}$ </div> </p>

<p> (**25**) <div style = "text-align:center"> $\widehat{ER}_{Unmarked,F} = 1 - (1 - \widehat{ER}_{Marked,F})^{\delta^{W}_{Marked} / \delta^{W}_{Unmarked}}$ </div> </p>
...
<p> (**26**) <div style = "text-align:center"> $\widehat{D}_{Unmarked,f} = N_{Unmarked} \times \widehat{ER}_{Unmarked,F} \times P_f$ </div> </p>
...
<p> (**27**) <div style = "text-align:center"> $P_f = \frac{ER_{Marked} \times \delta_{Unmarked,f}}{\sum_{f}^{F} ER_{Marked} \times \delta_{Unmarked,f}}$ </div> </p>
...
<p> (**28**) <div style = "text-align:center"> $\widehat{D}_{L, Unmarked, f} = \widehat D_{Unmarked,f} \times \frac{1 - \boldsymbol{ure}_f}{(1-\boldsymbol{ure}_f) + (\boldsymbol{ure}_f \times \boldsymbol{\delta}_f)}$ </div> </p>

and non-landed mortality ($\widehat D_{N, Unmarked, f}$) is calculated as:

<p> (**29**) <div style = "text-align:center"> $\widehat{D}_{N, Unmarked, f} = \widehat D_{Unmarked,f} \times \frac{\boldsymbol{ure}_f \times \boldsymbol{\delta}_f}{(1-\boldsymbol{ure}_f) + (\boldsymbol{ure}_f \times \boldsymbol{\delta}_f)}$ </div> </p>

Similarly, for a marked cohort:

<p> (**30**) <div style = "text-align:center"> $\widehat D_{L, Marked, f} = \widehat D_{Marked,f} \times \frac{\boldsymbol{mre}_f}{\boldsymbol{mre}_f + (1 - \boldsymbol{mre}_f) \times \boldsymbol{\delta}_f}$ </div> </p>

and non-landed mortality ($\widehat D_{N,Marked,f}$) is calculated as:

<p> (**31**) <div style = "text-align:center"> $\widehat D_{N,Marked,f} = \widehat D_{Marked,f} \times \frac{(1 - \boldsymbol{mre}_f) \times \boldsymbol{\delta}_f}{\boldsymbol{mre}_f + (1 - \boldsymbol{mre}_f) \times \boldsymbol{\delta}_f}$ </div> </p>
...
<p>**(16)**<div style = "text-align:center"><span title = "Stock scaler of stock s at age 3">$StockScaler_{s,a \! = \! 3}$</span> $=$ <span title = "Backward FRAM target for stock s.
