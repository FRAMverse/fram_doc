...
A simple diagram of the calibration process is presented in Figure \@ref(fig:cal-plot). This program flow works for all stocks with sufficient CWT representation in base period years (37 of the 38 FRAM stocks). For a description of how to handle CWT recoveries from "out-of-base" years see <a href = "https://framverse.github.io/fram_doc/calcs_glossary.html#Out-of-Base_(OOB)" target = "_blank" title = "Out-of-base">out-of-base procedures</a>.

![](Calibration Overview.jpg)(\#fig:cal-plot)

**Figure \@ref(fig:cal-plot).** Calibration Overview

These steps will be described in detail in section <a href = "https://framverse.github.io/fram_doc/base_chin_doc_calibration.html" target = "_blank" title = "Calibration Procedures">Calibration procedures</a>
...
For a complete description of stock profiles see <a href="/objects/2017ChinFRAMBP_StockProfilesJul24_2017xlsx.xlsx">2017ChinFRAMBP_StockProfilesJul24_2017xlsx.xlsx</a> and <a href="/objects/FRAM fishery profiles summary draft 06May2020 ahb.xlsx">FRAM fishery profiles summary draft 06May2020 ahb.xlsx</a>.
