...
For more information see <a href="literature/ProposalForELDU_7-10-2019.docx"> ProposalForELDU_7-10-2019.docx </a> and [.xls](xxx).

```{r JDFAgePPN, echo=FALSE,include = TRUE, results='asis'}
dplyr::tibble(
  `Age` = c(3, 4, 5),
  `Proportion` = c("45%","55%","4%")
) |>
  gt::gt() |>
