...
A simple diagram of the calibration process is presented in Figurexxx. This program flow works for all stocks with sufficient CWT representation in base period years (38 of the 39 FRAM stocks). For a description of how to handle CWT recoveries from "out-of-base" years see <a href = "https://framverse.github.io/fram_doc/calcs_glossary.html#Out-of-Base_(OOB)" target = "_blank" >Out-of-Base Procedures</a>.
...
- Richardson, Sarah (WDFW, fisheries biologist)
- Roose, Robert (Stillaguamish Tribe, fisheries biologist)
...
- Thurner, Stephanie (NWIFC, lead Coho modeler)
...
<br>
<span style='color:red;font-size:300%;'>Galen</span>
...
<br>
<span style='color:red;font-size:300%;'>Derek</span>
For more information see <a href="https://framverse.github.io/fram_doc/literature/2020-06-19%20BC_Data_Request_With_pre-2012.xlsx">
RE BC Data Request - Update.msg
short description Chinook Canadian catch imputation for post-season runs_Updated_For_Documentation_in_6.2023.docx</a> <!-- THIS LINK/PARAGRAPH IS AWKWARD -->
...
<span style='color:red;font-size:300%;'>Angelika or someone else</span>
